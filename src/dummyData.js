export const hero = [
  ...
  },
  {
    ...
    desc: [
      {
        para1:
          "Prior to the 2023 Presidential elections, Civil Society Organizations (CSOs) in the north-western part of Nigeria have been advocating for the active participation of rural women in the political and electoral processes in such a manner that will positively affect their lives. In Kano, one such CSO is the Women, Widows, and Orphans Development Initiative (WWODI), a member organization that drives the United Nation’s (UN) programme on Women, Peace and Security in Nigeria (WPSN). The programme was designed to achieve the broad goal of gender-inclusiveness and sustainable peace in Nigeria with the specific objectives of increasing women’s effective participation in peace and security processes, peace negotiations, conflict prevention, and resolution, and improving public perception of the role of women in peace and security at all levels.",
      },
      {
        para2:
